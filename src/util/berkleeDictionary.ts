...
/** */
export const rootDefinitions: Record<BerkleeFingeringType, RootDef> = {
...
export type BerkleeFingeringType = 'type1' | 'type1A' | 'type1B' | 'type1C' | 'type1D' | 'type2' | 'type3' | 'type4' | 'type4A' | 'type4B' | 'type4C' | 'type4D';

/**
 * 
 */
export const berkleeDictionary: { major: Record<BerkleeFingeringType, BerkleeStringData[]> } = {
  major: {
    type1: [
      {
